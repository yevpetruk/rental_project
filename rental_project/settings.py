...
#SECRET_KEY = 'django-insecure-p2x$#n*!5n#gl7qy-jt=0(7t172z-y3p%^zlu(^ms*yr97t^el'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME','ich1_rental_mydb'),
        'USER': os.getenv('DB_USER', 'ich1'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'ich1_password_ilovedbs'),
